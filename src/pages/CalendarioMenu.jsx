...
const CalendarioMenu = () => {
  ...
  const menus = {
    "2025-04-19": {
      titulo: "",
      descripcion: "Desayuno: Avena con frutas.<br>Almuerzo: Pollo a la plancha con ensalada.<br>Cena: Sopa de verduras.",
    },
    "2025-04-20": {
      titulo: "",
      descripcion: "Desayuno: Tostadas integrales con aguacate.<br>Almuerzo: Pescado al horno con arroz.<br>Cena: Ensalada de atún.",
    },
    "2025-04-21": {
      titulo: "",
      descripcion: "Desayuno: Omelette de espinaca.<br>Almuerzo: Lentejas guisadas con verduras.<br>Cena: Ensalada de atún y tomate.",
    },
  };
  ...
  const handleDiaClick = (fecha) => {
    ...
    if (menus[fechaStr]) {
      const titulo = menus[fechaStr].titulo &&
      ...
      <div id="menu-dia" className="menu-dia">
        {menuSeleccionado ? (
          <>
            ...
            <div dangerouslySetInnerHTML={{ __html: menuSeleccionado.descripcion }} />
          </>
        ) : (
          <em>Seleccione un día para ver el menú.</em>
        )}
      </div>
    </div>
  );
